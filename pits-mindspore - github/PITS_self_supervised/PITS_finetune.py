...
# python PITS_finetune.py --dset_pretrain 'etth1' --dset_finetune 'etth1' --n_epochs_finetune_head 5 --n_epochs_finetune_entire 10 --target_points 96 --num_patches 42 --context_points 512 --d_model 128 --patch_len 12 --stride 12 --is_finetune 1 
...
# 预测
# python PITS_pretrain.py --dset_pretrain 'etth1' --context_points 512 --d_model 128 --patch_len 12 --stride 12 --device_id 0

# 分类
# python PITS_pretrain.py --dset_pretrain 'SleepEEG' --n_epochs_pretrain {ep_pretrain}  --context_points {context_points} --d_model {d_model} --patch_len {patch_len} --stride {stride} 